...
set :scm, :git
set :repository,  "git@github.com:allanRoberto/lojaemotions.git"
# set :scm, :subversion
...
set :local_path, "/Users/Allan/sites/lojaemotions"
...
set :local_domain, 'lojaemotions.art.com.br'
