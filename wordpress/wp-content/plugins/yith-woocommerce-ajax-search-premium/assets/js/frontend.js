    ...
    el.each( function(){
        var $t = $(this),
            ...
            $t.yithautocomplete({
                ...
                serviceUrl: yith_wcas_params.ajax_url + '&post_type=' + post_type.val()+ '&lang='+ lang,
            ...
            if( search_categories.length ){
                search_categories.on( 'change', function( e ){
                    ...
                    if( search_categories.val() != '' ) {
                        ac.setOptions({
                            serviceUrl:  yith_wcas_params.ajax_url + '&product_cat=' + search_categories.val()+ '&lang='+lang
                        });
                    }else{
                        ac.setOptions({
                            serviceUrl:  yith_wcas_params.ajax_url + '&lang='+lang
                        });
                    }
