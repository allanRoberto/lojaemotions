...
gulp.task('sprite', function() {
    var spriteData = 
        gulp.src('app/images/sprite/*.*') // source path of the sprite images
            .pipe(spritesmith({
                imgName: 'sprite.png',
                cssName: 'sprite.scss',
                cssFormat : 'css',
    ...
    spriteData.css.pipe(gulp.dest('app/styles/scss/')); // output path for the CSS
});
